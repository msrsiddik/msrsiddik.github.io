...
Full-Stack Software Engineer (Go / Java / React)
...
Full-stack developer with 4+ years of experience building point-of-sale and healthcare products. I work mostly on the backend with Go and Java/Spring Boot, on the frontend with React, and on the client side with Android. I'm comfortable taking a feature from API design through to the user-facing client. In my own time I build systems like multi-tenant API gateways, offline-first sync, and authentication services. Based in Dhaka and open to remote work; I'm looking for a backend-focused engineering role.
...
- Ship features across Orocube's POS ecosystem (ORO POS, OroKiosk, online ordering).
- Build backend services and APIs that connect offline POS terminals with cloud and online-ordering platforms.
- Work with the team to take features from API design to the user-facing client.

### Assistant Software Engineer — Orocube Technologies
*Jan 2024 — Dec 2024*

- Took broader ownership of POS and healthcare features across backend and client applications.
...
- Worked with Java/Spring Boot on the backend and Android on the client side.
...
- Worked on features and fixes in Java-based desktop POS applications.
...
- **Backend:** Spring Boot, Vaadin, Go (net/http, gRPC), REST APIs, PostgreSQL, Redis
...
**Certificate in Mobile Application Development — Android** — BITM (BASIS Institute of Technology & Management), 2019
Three-month training program under the Skills for Employment Investment Program (SEIP), Finance Division, Ministry of Finance, Government of Bangladesh.
